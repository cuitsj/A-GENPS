...
reg [9:0] map_row,map_column;//地图的行列计数
reg [2:0] map_cntbit;//地图数据接收位计数
reg [19:0] map_addra;//地图的RAM地址
//map-BRAM
reg map_en,map_wea,map_dina;
wire map_douta;

//状态1,15,17
reg [12:0]  parent_node[2:0];
...
reg [9:0] close_cyin,close_cxin;
wire [9:0] close_cyout,close_cxout;
...
reg [12:0] openpy_addra,openpy_addrb;
reg [12:0] openpx_addra,openpx_addrb;
reg [12:0] opency_addra,opency_addrb;
reg [12:0] opencx_addra,opencx_addrb;
reg [12:0] openg1_addra,openg1_addrb;
reg [12:0] openg2_addra,openg2_addrb;
reg [12:0] openh_addra,openh_addrb;
reg [12:0] openf_addra,openf_addrb;

reg [9:0] openpy_dina,openpy_dinb;
reg [9:0] openpx_dina,openpx_dinb;
reg [9:0] opency_dina,opency_dinb;
reg [9:0] opencx_dina,opencx_dinb;
...
wire [9:0] openpy_douta,openpy_doutb;
wire [9:0] openpx_douta,openpx_doutb;
wire [9:0] opency_douta,opency_doutb;
wire [9:0] opencx_douta,opencx_doutb;
...
reg [9:0] child_node1[1:0],child_node2[1:0],child_node3[1:0],child_node4[1:0],child_node5[1:0],child_node6[1:0],child_node7[1:0],child_node8[1:0];

//状态5,6,7,8,9,10,11,12,14,16
reg [12:0] open_row;//openlist的总行数
reg [12:0] openreal_row;//openlist的真实行数
reg [12:0] open_addr1;//用于判断子节点是否在openlist中计数
reg [12:0] open_addr2;//用于从openlist中找新的父节点计数行数
reg [12:0] open_addr3;//用于从openlist中回溯路径计数
...
//状态19
reg [9:0] path_row,path_column;//用于缓存路径各节点坐标
