...
reg [8:0] map_row,map_column;//地图的行列计数
reg [2:0] map_cntbit;//地图数据接收位计数
reg [17:0] map_addra;//地图的RAM地址
//map-BRAM
...
reg [8:0] close_cyin,close_cxin;
wire [8:0] close_cyout,close_cxout;
...
reg [8:0] openpy_dina,openpy_dinb;
reg [8:0] openpx_dina,openpx_dinb;
reg [8:0] opency_dina,opency_dinb;
reg [8:0] opencx_dina,opencx_dinb;
reg [12:0] openg1_dina,openg1_dinb;
reg [12:0] openg2_dina,openg2_dinb;
reg [12:0] openh_dina,openh_dinb;
reg [12:0] openf_dina,openf_dinb;

wire [8:0] openpy_douta,openpy_doutb;
wire [8:0] openpx_douta,openpx_doutb;
wire [8:0] opency_douta,opency_doutb;
wire [8:0] opencx_douta,opencx_doutb;
wire [12:0] openg1_douta,openg1_doutb;
wire [12:0] openg2_douta,openg2_doutb;
wire [12:0] openh_douta,openh_doutb;
wire [12:0] openf_douta,openf_doutb;
...
reg [8:0] child_node1[1:0],child_node2[1:0],child_node3[1:0],child_node4[1:0],child_node5[1:0],child_node6[1:0],child_node7[1:0],child_node8[1:0];
...
//状态19
reg [8:0] path_row,path_column;//用于缓存路径各节点坐标
...
always @(posedge clk) begin
        ...
        else if (led0==0 && findpath_flag==0) begin
            cnt_time<=cnt_time+1;
        end
end
//例化ILA模块
